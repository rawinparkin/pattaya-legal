...
@section('title')
Blog by Category | Pattaya Legal Services
@endsection
@section('meta')
<meta property="og:title" content="Blog by Category | Pattaya Legal Services" />
    ...
    <div class="container">
        <div class="row no-gutters slider-text align-items-end justify-content-center">
            <div class="col-md-9 ftco-animate pb-5 text-center">
                <h1 class="mb-3 bread">{{ $categoryname->blog_category }}</h1>
            ...
            <div class="col-md-4 d-flex ftco-animate">
                <div class="blog-entry justify-content-end">
                    <div class="text px-4 py-4">
                        <h3 class="heading mb-0"><a href="#">{{ $item->blog_title }}</a></h3>
                    </div>
                    ...
                    <div class="text p-4 float-right d-block">
                        ...
                        <p>{{ strip_tags(substr($item->blog_description, 0,  110)) }} ...
                            <!-- {!! Str::limit($item->blog_description, 110) !!}  -->
                        </p>
